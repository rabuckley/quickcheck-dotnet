...
This library aims to provide similar functionality for .NET.
...
Say I've written a function to reverse `Memory<int>`. A property of a working reverse function is that reversing twice should give the original sequence. We can check that this is the case for our function using QuickCheck.
...
// Create an empty QuickChecker instance
